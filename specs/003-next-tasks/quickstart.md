# Quickstart: Next Tasks Execution
...
5) Mark the task complete after execution

## Verification

- The chosen task is clearly identified
- The task references a BASIC.md section
- Task status is updated without absolute paths in new notes
