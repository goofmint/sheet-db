...
- **フロントエンド**: Hono JSX (SSR + クライアント) + React Router v6 (CSR)
 ...
 * - Include React Router client-side script for SPA navigation
...
### 10. APIクライアント (src/lib/api-client.ts)
...
### 11. ヘルスチェックAPI更新 (src/routes/api.ts)
...
### 12. メインアプリケーション更新 (src/index.tsx)
